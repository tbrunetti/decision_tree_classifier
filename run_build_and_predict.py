...
def run(**kwargs):
	...
	if kwargs['balance_method'] == None:
		#build_decision_tree(data=formatted_matrix, prediction=args.predicted_outcome)
		data, ground_truth, tree_classifier, data_training, data_test, outcome_training, outcome_test = build_decision_tree.build_decision_tree(input=kwargs['matrixFile'], outcome=kwargs['target_outcome'], **kwargs)
...
if __name__ == '__main__':
	...
	parser.add_argument('--balance_method', default=None, dest='balance_method', help='method for balancing data set')
